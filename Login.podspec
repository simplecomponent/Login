...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/simplecomponent/Login"
  ...
  s.source       = { :git => "https://github.com/simplecomponent/Login.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Login/Login/**/*.{h,m,swift}"
